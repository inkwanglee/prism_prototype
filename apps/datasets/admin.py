# =============================================================================
# Django Admin registration for legacy Dataset / Collar / Survey models.
# =============================================================================
...
class SurveyAdmin(admin.ModelAdmin):
    ...
    # `collar__hole_id` traverses the FK to make Surveys searchable by
    # the parent collar's hole id.
